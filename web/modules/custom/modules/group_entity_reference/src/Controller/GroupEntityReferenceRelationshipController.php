 ...
 */
class GroupEntityReferenceRelationshipController extends GroupRelationshipController {
    ...
    public function addPage(GroupInterface $group, $create_mode = FALSE, $base_plugin_id = NULL) {
        ...
        foreach ($page_bundles as $plugin_id => $bundle_name) {
            // Don't process Media types. They are handled by GroupEntityReferenceMediaController.
     ...
     *   The group to create the group relationship in.
     * @param string $plugin_id
     *   The group relationship enabler to create relationship with.
     *
     * @return string
     *   The page title.
     */
